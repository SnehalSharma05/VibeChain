function ProfileSection() {
  const userProfile = {
    name: "Snehal Sharma",
    avatar:
      "https://media.licdn.com/dms/image/v2/D4D03AQE1RDlOuwbJrw/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1729742877150?e=1736985600&v=beta&t=FE8YUfeK0rJ1xDPJudjPE7TRewtW3ilL12W6fjk_yAs",
    totalCoins: 2345.67,
    purchases: [
  ...
  return (
    <div className="p-6 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-zinc-800 rounded-lg p-4">
          <h3 className="text-zinc-400 text-sm">Created Tracks</h3>
